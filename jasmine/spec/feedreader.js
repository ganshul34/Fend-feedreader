...
$(function() {
    ...
    */
    ...
    describe('The menu', function () {
        ...
        it('has menu element is hidden by default', function () {
    ...
    describe('Initial Entries', function() {
        ...
        it ('load feed check and has atleast one entry', function(done) {
    ...
    describe('New Feed Selection', function() {
        ...
        it('nextFeed is not equal to previousfeed', function() {
            expect(previousfeed).not.toEqual(nextfeed); // old and new feed is not same
        });
    });
